...
def upgrade() -> None:
    ...
    sa.Column('provider', sa.Enum('github', 'google_calendar', 'teams_calendar', 'slack', 'gitlab', 'jira', 'telegram', 'notion', 'discord', name='integration_provider'), nullable=False),
    ...
    op.create_index(op.f('ix_integration_tokens_integration_id'), 'integration_tokens', ['integration_id'], unique=False)
