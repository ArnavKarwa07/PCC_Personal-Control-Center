...
def create_project(
    ...
    project = project_service.create_project(db=db, data=data)
    return {
...
def get_project_by_id(
    ...
    project = project_service.get_project_response(db=db, project_id=project_id)
    return {
        "data": project.model_dump(),
    }
...
def get_project_board(
    ...
    board = project_service.get_project_board(db=db, project_id=project_id)
    return {
